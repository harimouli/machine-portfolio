...
export const ProjectCard = (props: ProjectProps) => {
    ...
    return (
        <div className = "flex-col items-center   w-64 rounded-md shadow-slate-300 shadow-md transition duration-300  ease-in-out border-t border-slate-300 hover:scale-105 hover:shadow-xl">
